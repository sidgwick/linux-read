...
#define ATIXL_MSE_DISABLE_UPDATE()                                                                 \
    {                                                                                              \
        outb(0x07, ATIXL_MSE_CONTROL_PORT);                                                        \
        outb((0x20 | inb(ATIXL_MSE_DATA_PORT)), ATIXL_MSE_DATA_PORT);                              \
    }

/* Select IR7, Enable updates (INT ENABLED) */
#define ATIXL_MSE_ENABLE_UPDATE()                                                                  \
    {                                                                                              \
        outb(0x07, ATIXL_MSE_CONTROL_PORT);                                                        \
...
struct file_operations atixl_busmouse_fops = {
    NULL,                              /* mouse_seek */
    read_mouse,   write_mouse,   NULL, /* mouse_readdir */
    mouse_select,                      /* mouse_select */
    NULL,                              /* mouse_ioctl */
    NULL,                              /* mouse_mmap */
    open_mouse,   release_mouse,
};
