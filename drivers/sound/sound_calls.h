...
int audio_ioctl(int dev, struct fileinfo *file, unsigned int cmd, unsigned int arg);
...
int MIDIbuf_ioctl(int dev, struct fileinfo *file, unsigned int cmd, unsigned int arg);
...
int sound_ioctl_sw(int dev, struct fileinfo *file, unsigned int cmd, unsigned long arg);
...
int pmgr_inform(int dev, int event, unsigned long parm1, unsigned long parm2, unsigned long parm3,
                unsigned long parm4);
