...
#define SCSI_DEBUG                                                                                 \
    {                                                                                              \
        "SCSI DEBUG", scsi_debug_detect, scsi_debug_info, scsi_debug_command,                      \
            scsi_debug_queuecommand, scsi_debug_abort, scsi_debug_reset, NULL,                     \
            scsi_debug_biosparam, SCSI_DEBUG_MAILBOXES, 7, SG_ALL, 1, 0, 1                         \
    }
#endif
