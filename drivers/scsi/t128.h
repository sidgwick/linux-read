...
#define TRANTOR_T128                                                                               \
    {                                                                                              \
        "Trantor T128/T128F/T228", t128_detect, t128_info, NULL, t128_queue_command, t128_abort,   \
            t128_reset, NULL, t128_biosparam, /* can queue */ CAN_QUEUE, /* id */ 7, SG_ALL,       \
            /* cmd per lun */ CMD_PER_LUN, 0, 0                                                    \
    }

#else

#define NCR5380_implementation_fields volatile unsigned char *base

#define NCR5380_local_declare() volatile unsigned char *base

#define NCR5380_setup(instance) base = (volatile unsigned char *)(instance)->base
...
#define NCR5380_read(reg)                                                                          \
    (((unsigned char)printk("scsi%d : read register %d at address %08x\n", instance->hostno,       \
                            (reg), T128_address(reg))),                                            \
     *(T128_address(reg)))

#define NCR5380_write(reg, value)                                                                  \
    {                                                                                              \
        printk("scsi%d : write %02x to register %d at address %08x\n", instance->hostno, (value),  \
               (reg), T128_address(reg));                                                          \
