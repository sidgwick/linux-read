...
#define SEAGATE_ST0X                                                                               \
    {                                                                                              \
        "Seagate ST-01/ST-02", seagate_st0x_detect, seagate_st0x_info, seagate_st0x_command,       \
            seagate_st0x_queue_command, seagate_st0x_abort, seagate_st0x_reset, NULL,              \
            seagate_st0x_biosparam, 1, 7, SG_ALL, 1, 0, 0                                          \
    }
#endif
...
#define PHASE_ETC                                                                                  \
    (PHASE_DATAIN | PHASE_DATA_OUT | PHASE_CMDOUT | PHASE_MSGIN | PHASE_MSGOUT | PHASE_STATUSIN)
