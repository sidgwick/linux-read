...
#define xscsi2int(up)                                                                              \
    ((((long)(up)[0]) << 24) + (((long)(up)[1]) << 16) + (((long)(up)[2]) << 8) + ((long)(up)[3]))
...
#define AHA1542                                                                                    \
    {                                                                                              \
        "Adaptec 1542", aha1542_detect, aha1542_info, aha1542_command, aha1542_queuecommand,       \
            aha1542_abort, aha1542_reset, NULL, aha1542_biosparam, AHA1542_MAILBOXES, 7,           \
            AHA1542_SCATTER, AHA1542_CMDLUN, 0, 1                                                  \
    }
