...
#define AHA152X                                                                                    \
    { /* name */                                                                                   \
        "Adaptec 152x SCSI driver", /* detect */ aha152x_detect, /* info */ aha152x_info,          \
            /* command */ aha152x_command, /* queuecommand */ aha152x_queue,                       \
            /* abort */ aha152x_abort, /* reset */ aha152x_reset, /* slave_attach */ /* NULL */ 0, \
            /* bios_param */ aha152x_biosparam, /* can_queue */ 1, /* this_id */ 7,                \
            /* sg_tablesize */ SG_ALL, /* cmd_per_lun */ 1, /* present */ 0,                       \
            /* unchecked_isa_dma */ 0                                                              \
    }
#endif
...
/* SCSI transfer count */
#define GETSTCNT() ((GETPORT(STCNT2) << 16) + (GETPORT(STCNT1) << 8) + GETPORT(STCNT0))
