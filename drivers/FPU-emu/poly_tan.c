...
static unsigned short const oddplterms[HIPOWERop][4] = {{0x846a, 0x42d1, 0xb544, 0x921f},
                                                        {0x6fb2, 0x0215, 0x95c0, 0x099c},
                                                        {0xfce6, 0x0cc8, 0x1c9a, 0x0000}};

#define HIPOWERon 2 /* odd poly, negative terms */
static unsigned short const oddnegterms[HIPOWERon][4] = {{0x6906, 0xe205, 0x25c8, 0x8838},
                                                         {0x1dd7, 0x3fe3, 0x944e, 0x002c}};

#define HIPOWERep 2 /* even poly, positive terms */
static unsigned short const evenplterms[HIPOWERep][4] = {{0xdb8f, 0x3761, 0x1432, 0x2acf},
                                                         {0x16eb, 0x13c1, 0x3099, 0x0003}};

#define HIPOWERen 2 /* even poly, negative terms */
static unsigned short const evennegterms[HIPOWERen][4] = {{0x3a7c, 0xe4c5, 0x7f87, 0x2945},
...
void poly_tan(FPU_REG const *arg, FPU_REG *result, int invert)
{
    ...
    *(short *)&(neg_poly.sign) = 0;
    ...
    mul64(&significand(&argSq), &significand(&neg_poly), &significand(&neg_poly));
    ...
    *(short *)&(pos_poly.sign) = 0;
    ...
    mul64(&significand(&argSq), &significand(&pos_poly), &significand(&pos_poly));
