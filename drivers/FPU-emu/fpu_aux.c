...
void fclex(void)
{
    partial_status &= ~(SW_Backward | SW_Summary | SW_Stack_Fault | SW_Precision | SW_Underflow |
                        SW_Overflow | SW_Zero_Div | SW_Denorm_Op | SW_Invalid);
    NO_NET_DATA_EFFECT;
...
static FUNC const finit_table[] = {feni,   fdisi,       fclex,       finit,
...
static FUNC const fstsw_table[] = {fstsw_ax,    FPU_illegal, FPU_illegal, FPU_illegal,
...
static FUNC const fp_nop_table[] = {fnop,        FPU_illegal, FPU_illegal, FPU_illegal,
                                    FPU_illegal, FPU_illegal, FPU_illegal, FPU_illegal};
