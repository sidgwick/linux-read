...
void reg_load_bcd(void)
{
    ...
    FPU_loaded_data.sign =
        ((unsigned char)get_fs_byte((unsigned char *)s + 9)) & 0x80 ? SIGN_NEG : SIGN_POS;
    RE_ENTRANT_CHECK_ON;
...
int reg_store_int64(void)
{
    ...
    } else if ((FPU_st0_tag == TW_Infinity) || (FPU_st0_tag == TW_NaN)) {
        EXCEPTION(EX_Invalid);
        goto invalid_operand;
    }
...
int reg_store_int32(void)
{
    ...
    reg_move(FPU_st0_ptr, &t);
    precision_loss = round_to_int(&t);
    if (t.sigh || ((t.sigl & 0x80000000) && !((t.sigl == 0x80000000) && (t.sign == SIGN_NEG)))) {
        EXCEPTION(EX_Invalid);
        /* This is a special case: see sec 16.2.5.1 of the 80486 book */
    invalid_operand:
        if (control_word & EX_Invalid) {
...
int reg_store_int16(void)
{
    ...
    reg_move(FPU_st0_ptr, &t);
    precision_loss = round_to_int(&t);
    if (t.sigh || ((t.sigl & 0xffff8000) && !((t.sigl == 0x8000) && (t.sign == SIGN_NEG)))) {
        EXCEPTION(EX_Invalid);
        /* This is a special case: see sec 16.2.5.1 of the 80486 book */
    invalid_operand:
        if (control_word & EX_Invalid) {
...
int reg_store_bcd(void)
{
    ...
    if ((t.sigh > 0x0de0b6b3) || ((t.sigh == 0x0de0b6b3) && (t.sigl > 0xa763ffff))) {
        EXCEPTION(EX_Invalid);
        /* This is a special case: see sec 16.2.5.1 of the 80486 book */
    invalid_operand:
        if (control_word & CW_Invalid) {
...
char *fldenv(fpu_addr_modes addr_modes)
{
    ...
    if (addr_modes.vm86 || (addr_modes.override.operand_size == OP_SIZE_PREFIX)) {
        RE_ENTRANT_CHECK_OFF;
...
char *fstenv(fpu_addr_modes addr_modes)
{
    ...
    if (addr_modes.vm86 || (addr_modes.override.operand_size == OP_SIZE_PREFIX)) {
        ...
        if (addr_modes.vm86) {
            put_fs_word((ip_offset & 0xf0000) >> 4, (unsigned short *)(d + 8));
            put_fs_word((data_operand_offset & 0xf0000) >> 4, (unsigned short *)(d + 0x0c));
        } else {
