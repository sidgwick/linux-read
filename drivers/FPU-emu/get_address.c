...
static int reg_offset[] = {offsetof(struct info, ___eax), offsetof(struct info, ___ecx),
...
static int reg_offset_vm86[] = {
    offsetof(struct info, ___cs),      offsetof(struct info, ___vm86_ds),
    offsetof(struct info, ___vm86_es), offsetof(struct info, ___vm86_fs),
    offsetof(struct info, ___vm86_gs), offsetof(struct info, ___ss)};

#define VM86_REG_(x) (*(unsigned short *)(reg_offset_vm86[((unsigned)x)] + (char *)FPU_info))
...
void get_address(unsigned char FPU_modrm, unsigned long *fpu_eip, fpu_addr_modes addr_modes)
{
    unsigned char mod;
    long *cpu_reg_ptr;
...
void get_address_16(unsigned char FPU_modrm, unsigned long *fpu_eip, fpu_addr_modes addr_modes)
{
    unsigned char mod;
