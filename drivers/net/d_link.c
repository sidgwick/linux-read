static char *version = "d_link.c: $Revision: 0.32 $,  Bjorn Ekwall (bj0rn@blox.se)\n";
/*
 *    d_link.c
 *
...
static inline int d_link_read_status(struct device *dev)
{
    int status;
...
static inline unsigned char d_link_read_byte(unsigned char type, struct device *dev)
{ /* dev used by macros */
    unsigned char lo;
...
static inline void trigger_interrupt(struct device *dev)
{
