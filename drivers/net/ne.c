...
static char *version = "ne.c:v0.99-15k 3/3/94 Donald Becker (becker@super.org)\n";
...
static void ne_block_output(struct device *dev, const int count, const unsigned char *buf,
...
static void ne_block_output(struct device *dev, int count, const unsigned char *buf,
                            const int start_page)
{
    int retries = 0;
