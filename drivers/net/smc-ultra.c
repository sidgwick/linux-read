...
static char *version = "smc-ultra.c:v0.07 3/1/94 Donald Becker (becker@super.org)\n";
...
static int ultra_block_input(struct device *dev, int count, char *buf, int ring_offset);
static void ultra_block_output(struct device *dev, int count, const unsigned char *buf,
                               const start_page);
