...
static int ext2_follow_link(struct inode *, struct inode *, int, int, struct inode **);
...
static int ext2_follow_link(struct inode *dir, struct inode *inode, int flag, int mode,
