...
int nfs_proc_getattr(struct nfs_server *server, struct nfs_fh *fhandle, struct nfs_fattr *fattr)
{
    int *p, *p0;
    int status;
    int ruid = 0;
...
int nfs_proc_setattr(struct nfs_server *server, struct nfs_fh *fhandle, struct nfs_sattr *sattr,
...
int nfs_proc_readlink(struct nfs_server *server, struct nfs_fh *fhandle, char *res)
{
    int *p, *p0;
    int status;
    int ruid = 0;
...
int nfs_proc_read(struct nfs_server *server, struct nfs_fh *fhandle, int offset, int count,
...
int nfs_proc_write(struct nfs_server *server, struct nfs_fh *fhandle, int offset, int count,
                   char *data, struct nfs_fattr *fattr)
{
    int *p, *p0;
    int status;
...
int nfs_proc_create(struct nfs_server *server, struct nfs_fh *dir, const char *name,
...
int nfs_proc_rename(struct nfs_server *server, struct nfs_fh *old_dir, const char *old_name,
...
int nfs_proc_link(struct nfs_server *server, struct nfs_fh *fhandle, struct nfs_fh *dir,
                  const char *name)
{
    int *p, *p0;
    int status;
...
int nfs_proc_symlink(struct nfs_server *server, struct nfs_fh *dir, const char *name,
...
int nfs_proc_mkdir(struct nfs_server *server, struct nfs_fh *dir, const char *name,
                   struct nfs_sattr *sattr, struct nfs_fh *fhandle, struct nfs_fattr *fattr)
{
    int *p, *p0;
    int status;
...
int nfs_proc_readdir(struct nfs_server *server, struct nfs_fh *fhandle, int cookie, int count,
...
int nfs_proc_statfs(struct nfs_server *server, struct nfs_fh *fhandle, struct nfs_fsinfo *res)
{
    int *p, *p0;
    int status;
    int ruid = 0;
