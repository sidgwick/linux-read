...
static int pipe_ioctl(struct inode *pino, struct file *filp, unsigned int cmd, unsigned long arg)
{
    int error;
 ...
 */
struct file_operations connecting_fifo_fops = {pipe_lseek,
                                               connect_read,
                                               bad_pipe_rw,
                                               pipe_readdir,
                                               connect_select,
...
struct file_operations read_fifo_fops = {pipe_lseek,
                                         pipe_read,
                                         bad_pipe_rw,
                                         pipe_readdir,
                                         fifo_select,
...
struct file_operations write_fifo_fops = {pipe_lseek,
                                          bad_pipe_rw,
                                          pipe_write,
                                          pipe_readdir,
                                          fifo_select,
...
struct file_operations rdwr_fifo_fops = {pipe_lseek,
                                         pipe_read,
                                         pipe_write,
                                         pipe_readdir,
                                         fifo_select,
...
struct file_operations read_pipe_fops = {pipe_lseek,
                                         pipe_read,
                                         bad_pipe_rw,
                                         pipe_readdir,
                                         pipe_select,
...
struct file_operations write_pipe_fops = {pipe_lseek,
                                          bad_pipe_rw,
                                          pipe_write,
                                          pipe_readdir,
                                          pipe_select,
...
struct file_operations rdwr_pipe_fops = {pipe_lseek,
                                         pipe_read,
                                         pipe_write,
                                         pipe_readdir,
                                         pipe_select,
