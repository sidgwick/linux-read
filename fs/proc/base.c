...
static struct proc_dir_entry base_dir[] = {
    {1, 2, ".."},    {2, 1, "."},      {3, 3, "mem"},  {4, 3, "cwd"},     {5, 4, "root"},
    {6, 3, "exe"},   {7, 2, "fd"},     {8, 4, "mmap"}, {9, 7, "environ"}, {10, 7, "cmdline"},
    {11, 4, "stat"}, {12, 5, "statm"}, {15, 4, "maps"}};
...
static int proc_lookupbase(struct inode *dir, const char *name, int len, struct inode **result)
{
...
static int proc_readbase(struct inode *inode, struct file *filp, struct dirent *dirent, int count)
{
