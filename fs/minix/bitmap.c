...
static unsigned long count_used(struct buffer_head *map[], unsigned numblocks, unsigned numbits)
{
...
{
    return (sb->u.minix_sb.s_nzones - count_used(sb->u.minix_sb.s_zmap,
