...
static int xiafs_readlink(struct inode *, char *, int);

static int xiafs_follow_link(struct inode *, struct inode *, int, int, struct inode **);
...
static int xiafs_follow_link(struct inode *dir, struct inode *inode, int flag, int mode,
