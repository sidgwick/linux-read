...
// 相关说明参见 gcc手册“Target Description Macros”章中“Implementing the Varargs Macros”小节
 ...
 * 最后一个指定参数. &(LASTARG) 用于取其地址(即其指针), 并且该指针是字符类型, 加上 LASTARG 的
 * 宽度值后 AP 就是可变参数表中第一个参数的指针. 该宏没有返回值 */
#ifndef __sparc__
