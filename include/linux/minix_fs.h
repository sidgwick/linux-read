...
extern int minix_lookup(struct inode *dir, const char *name, int len, struct inode **result);
...
extern int minix_symlink(struct inode *inode, const char *name, int len, const char *symname);
