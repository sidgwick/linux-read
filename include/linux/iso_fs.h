...
extern int get_rock_ridge_filename(struct iso_directory_record *, char **name, int *len,
                                   struct inode *);
...
extern int isofs_lookup(struct inode *dir, const char *name, int len, struct inode **result);
