...
extern int xiafs_lookup(struct inode *dir, const char *name, int len, struct inode **result);
...
extern int xiafs_symlink(struct inode *inode, const char *name, int len, const char *symname);
extern int xiafs_link(struct inode *oldinode, struct inode *dir, const char *name, int len);
extern int xiafs_mknod(struct inode *dir, const char *name, int len, int mode, int rdev);
extern int xiafs_rename(struct inode *old_dir, const char *old_name, int old_len,
