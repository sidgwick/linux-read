...
struct vm_operations_struct {
    ...
    void (*nopage)(int error_code, struct vm_area_struct *area, unsigned long address);
...
extern void do_wp_page(unsigned long error_code, unsigned long address, struct task_struct *tsk,
                       unsigned long user_esp);
extern void do_no_page(unsigned long error_code, unsigned long address, struct task_struct *tsk,
                       unsigned long user_esp);

extern unsigned long paging_init(unsigned long start_mem, unsigned long end_mem);
extern void mem_init(unsigned long low_start_mem, unsigned long start_mem, unsigned long end_mem);
...
/* mmap.c */
extern int do_mmap(struct file *file, unsigned long addr, unsigned long len, unsigned long prot,
...
extern int ignoff_mergep(const struct vm_area_struct *, const struct vm_area_struct *, void *);
