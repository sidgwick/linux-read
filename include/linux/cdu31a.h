...
#define SONY_DETECT_TIMEOUT                                                                        \
    80 /* Maximum amount of time
                       that drive detection code
                       will wait for response
                       from drive (in 1/100th's
                       of seconds). */

#define SONY_JIFFIES_TIMEOUT                                                                       \
    500 /* Maximum number of times the
                       drive will wait/try for an
                       operation */
#define SONY_RESET_TIMEOUT                                                                         \
    100 /* Maximum number of times the
                       drive will wait/try a reset
                       operation */
#define SONY_READY_RETRIES                                                                         \
    20000 /* How many times to retry a
                       spin waiting for a register
                       to come ready */

#define MAX_CDU31A_RETRIES                                                                         \
    3 /* How many times to retry an
                       operation */
