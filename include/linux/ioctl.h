 ...
 */
#define _IOW(c, d, t) (IOC_IN | ((sizeof(t) << 16) & IOCSIZE_MASK) | ((c) << 8) | (d))
#define _IOR(c, d, t) (IOC_OUT | ((sizeof(t) << 16) & IOCSIZE_MASK) | ((c) << 8) | (d))
/* WR rather than RW to avoid conflict with stdio.h */
#define _IOWR(c, d, t) (IOC_INOUT | ((sizeof(t) << 16) & IOCSIZE_MASK) | ((c) << 8) | (d))
