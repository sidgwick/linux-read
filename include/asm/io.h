...
__OUT1(s##c_p,x) __OUT2(s,s1,"") : : "a" (value), "d" (port));                                     \
    SLOW_DOWN_IO;                                                                                  \
    }

#define __IN1(s)                                                                                   \
    static inline unsigned int __in##s(unsigned short port)                                        \
    {                                                                                              \
        unsigned int _v;
...
__IN1(s##c) __IN2(s,s1,"") : "=a" (_v) : "d" (port) ,##i );                                        \
    return _v;                                                                                     \
    }                                                                                              \
...
__IN1(s##c_p) __IN2(s,s1,"") : "=a" (_v) : "d" (port) ,##i );                                      \
    SLOW_DOWN_IO;                                                                                  \
    return _v;                                                                                     \
    }
...
#define inb(port) ((__builtin_constant_p((port)) && (port) < 256) ? __inbc(port) : __inb(port))
...
#define inw(port) ((__builtin_constant_p((port)) && (port) < 256) ? __inwc(port) : __inw(port))
...
#define inl(port) ((__builtin_constant_p((port)) && (port) < 256) ? __inlc(port) : __inl(port))
