...
static int packet_sendto(struct sock *sk, unsigned char *from, int len, int noblock, unsigned flags,
 ...
 */
int packet_recvfrom(struct sock *sk, unsigned char *to, int len, int noblock, unsigned flags,
                    struct sockaddr_in *sin, int *addr_len)
{
    ...
    memcpy_tofs(to, skb->data,
                copied); /* Don't use skb_copy_datagram here: We can't get frag chains */
...
struct proto packet_prot = {sock_wmalloc,
                            sock_rmalloc,
                            sock_wfree,
                            sock_rfree,
                            sock_rspace,
